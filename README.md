文字检测主要使用了浙大的[pixellink](https://github.com/ZJULearning/pixel_link)

在文字识别OCR模型上使用西安交通大学人工智能实践大赛第一名@ yinchangchang 的方案<https://github.com/yinchangchang/ocr_densenet>

可选：使用[Unet](https://github.com/zhixuhao/unet)进行单字再次分割
...
<details>
    <summary>算法流程简要介绍</summary>
    <p>首先使用pixel link进行文本检测，分割图片，随后进行仿射变换校正图片，将图片作为Densenet的输入进行文本内容识别。</p>
</details>
